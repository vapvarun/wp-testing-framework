<?php
/**
 * Integration tests for Community Members component
 * 
 * @package buddynext
 */
...
class CommunityMembersIntegrationTest extends WP_UnitTestCase {
    ...
    public function test_component_is_active() {
        $this->assertTrue(
            ...
            'Community Members component should be active'
        );
    }
    ...
    public function test_component_initialization() {
        ...
        $this->assertNotNull(
            buddypress()->members,
            'Community Members component should be initialized'
        );
    }

<?php
/**
 * Integration tests for Site Tracking component
 * 
 * @package buddynext
 */
...
class SiteTrackingIntegrationTest extends WP_UnitTestCase {
    ...
    public function test_component_is_active() {
        $this->assertTrue(
            bp_is_active('blogs'),
            'Site Tracking component should be active'
        );
    }
    ...
    public function test_component_initialization() {
        ...
        $this->assertNotNull(
            buddypress()->blogs,
            'Site Tracking component should be initialized'
        );
    }

<?php
/**
 * Integration tests for Extended Profiles component
 * 
 * @package buddynext
 */
...
class ExtendedProfilesIntegrationTest extends WP_UnitTestCase {
    ...
    public function test_component_is_active() {
        $this->assertTrue(
            ...
            'Extended Profiles component should be active'
        );
    }
    ...
    public function test_component_initialization() {
        ...
        $this->assertNotNull(
            buddypress()->xprofile,
            'Extended Profiles component should be initialized'
        );
    }

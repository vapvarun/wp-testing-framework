<?php
/**
 * Integration tests for Account Settings component
 * 
 * @package buddynext
 */
...
class AccountSettingsIntegrationTest extends WP_UnitTestCase {
    ...
    public function test_component_is_active() {
        $this->assertTrue(
            ...
            'Account Settings component should be active'
        );
    }
    ...
    public function test_component_initialization() {
        ...
        $this->assertNotNull(
            buddypress()->settings,
            'Account Settings component should be initialized'
        );
    }

<?php
/**
 * Integration tests for User Groups component
 * 
 * @package buddynext
 */
...
class UserGroupsIntegrationTest extends WP_UnitTestCase {
    ...
    public function test_component_is_active() {
        $this->assertTrue(
            bp_is_active('groups'),
            'User Groups component should be active'
        );
    }
    ...
    public function test_component_initialization() {
        ...
        $this->assertNotNull(
            buddypress()->groups,
            'User Groups component should be initialized'
        );
    }

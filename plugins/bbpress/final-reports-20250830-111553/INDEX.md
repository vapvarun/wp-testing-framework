...
### Test Reports
- `report-20250830-111553.html` - Visual dashboard
- `security-20250830-111553.txt` - Security scan results
- `performance-20250830-111553.txt` - Performance metrics
- `coverage-20250830-111553.txt` - Test coverage data
...
```bash
cat performance-20250830-111553.txt

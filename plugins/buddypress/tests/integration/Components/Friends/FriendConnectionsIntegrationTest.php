<?php
/**
 * Integration tests for Friend Connections component
 * 
 * @package buddynext
 */
...
class FriendConnectionsIntegrationTest extends WP_UnitTestCase {
    ...
    public function test_component_is_active() {
        $this->assertTrue(
            ...
            'Friend Connections component should be active'
        );
    }
    ...
    public function test_component_initialization() {
        ...
        $this->assertNotNull(
            buddypress()->friends,
            'Friend Connections component should be initialized'
        );
    }

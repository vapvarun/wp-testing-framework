<?php
/**
 * Integration tests for BuddyPress Core component
 * 
 * @package buddynext
 */
...
class BuddyPressCoreIntegrationTest extends WP_UnitTestCase {
    ...
    public function test_component_is_active() {
        $this->assertTrue(
            bp_is_active('core'),
            'BuddyPress Core component should be active'
        );
    }
    ...
    public function test_component_initialization() {
        ...
        $this->assertNotNull(
            buddypress()->core,
            'BuddyPress Core component should be initialized'
        );
    }

<?php
/**
 * Integration tests for Private Messaging component
 * 
 * @package buddynext
 */
...
class PrivateMessagingIntegrationTest extends WP_UnitTestCase {
    ...
    public function test_component_is_active() {
        $this->assertTrue(
            ...
            'Private Messaging component should be active'
        );
    }
    ...
    public function test_component_initialization() {
        ...
        $this->assertNotNull(
            buddypress()->messages,
            'Private Messaging component should be initialized'
        );
    }
